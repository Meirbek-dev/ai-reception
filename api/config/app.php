...
return [
    ...
    */
    ...
    'name' => env('APP_NAME', 'AI Reception'),
    ...
    */
    ...
    'locale' => env('APP_LOCALE', 'erun'),

    'fallback_locale' => env('APP_FALLBACK_LOCALE', 'ru'),

    'faker_locale' => env('APP_FAKER_LOCALE', 'ru_KZ'),
    ...
    */
    ...
    'tesseract_timeout'       => (int) env('TESSERACT_TIMEOUT', 60),
